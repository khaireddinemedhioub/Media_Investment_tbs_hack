Media_Investment_tbs_hack is a ML competition hold in TBS. The goal of this challenge is to predict the budget respective to each campaign ID given certain features.
